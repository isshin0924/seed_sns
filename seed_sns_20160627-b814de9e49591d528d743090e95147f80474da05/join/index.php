<?php
  ...
  if (!empty($_POST)) {
    ...
    if (empty($error)) {
        $sql = sprintf(
          //COUNT(*)条件に一致したデータの数を返す
          //countは件数を取ってくる
          //asは名前を変える(countとくるところをcntで表示する)
    ...
    if (empty($error)) {
      ...
      //$_FILES[パラメータ名][tmp_name]」は、ファイルの仮置き場のパス（テンポラリフォルダ）
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-3 content-margin-top">
        <legend>会員登録</legend>
        <!-- enctype="multipart/form-data"で画像データを扱えるようにする -->
