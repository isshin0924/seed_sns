<?php 
  ...
  if (isset($_SESSION['id']) && $_SESSION['time'] + 3600 > time()) {
    ...
    //mysqli_fetch_assocでデータを使えるものにしている
    //ログインしているメンバー情報すべて入る
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <li><a href="likes.php">お気に入り集</a></li>
          ...
          <ul class="paging">
            <input type="submit" class="btn btn-info" value="つぶやく">
                ...
                <?php if($page > 1): ?>
                  ...
                  <li><a href="index2.php?page=<?php print($page - 1); ?>" class="btn btn-default">前</a></li>
                <?php else: ?>
                ...
                <?php if($page < $maxPage): ?>
                  ...
                  <li><a href="index2.php?page=<?php print($page + 1); ?>" class="btn btn-default">次</a></li>
                <?php else: ?>
